...
[Table("Tasks")]
public sealed class EntityPartyTask
{
    private EntityPartyTask()
    {
    }

    public EntityPartyTask(Guid id, string title, string assignee, string dueDate, string description, string status, bool done)
    {
        Id = id;
        Title = title;
        Assignee = assignee;
