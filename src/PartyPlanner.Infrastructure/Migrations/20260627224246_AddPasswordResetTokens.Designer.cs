...
namespace PartyPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260627224246_AddPasswordResetTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartyPlanner.Core.Entities.EntityConvite", b =>
                {
                    ...
                    b.Property<string>("SenhaPresente")
                        .IsRequired()
                        .HasMaxLength(80)
            ...
            modelBuilder.Entity("PartyPlanner.Core.Entities.EntityPasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PartyPlanner.Core.Entities.EntityParty", b =>
                {
                    ...
                    b.OwnsOne("PartyPlanner.Core.Entities.EntityBudget", "EntityBudget", b1 =>
                        {
                            b1.Property<Guid>("EntityPartyId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("EntityPartyId");

                            b1.ToTable("Parties");

                            b1.WithOwner()
                                .HasForeignKey("EntityPartyId");
