...
public interface IPartyService
{
    ...
    Task<PartyResponse?> DeleteTaskAsync(Guid ownerUserId, Guid partyId, Guid taskId, CancellationToken cancellationToken = default);
    ...
    Task<PartyResponse?> DeleteGuestAsync(Guid ownerUserId, Guid partyId, Guid guestId, CancellationToken cancellationToken = default);
    ...
    Task<PartyResponse?> UpdateBudgetItemAsync(Guid ownerUserId, Guid partyId, Guid budgetItemId, CreateBudgetItemRequest request, CancellationToken cancellationToken = default);
    Task<PartyResponse?> DeleteBudgetItemAsync(Guid ownerUserId, Guid partyId, Guid budgetItemId, CancellationToken cancellationToken = default);
